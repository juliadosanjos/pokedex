...
export const getPokemons = (limit: Number = 50, offset: Number = 0): Promise<AxiosResponse<PokemonGetResponse>> => 
  axios.get(`https://pokeapi.co/api/v2/pokemon?limit=${limit}&offset=${offset}`)

export const getPokemonsData = (url): Promise<AxiosResponse<PokemonGetDataResponse>> => 
  axios.get(`url`)
